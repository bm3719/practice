...
DARPA project called Big Data, performing research towards developing an
analytics framework that operates against extremely large datasets.
\begin{achievements}
...
\item Researching state of the art in cloud computing and its applicability to
  project goals.
