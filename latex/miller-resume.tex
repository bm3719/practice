...
{xxxxx Waterside View Dr., Apt xx $\bullet$ Reston, VA 20194}
...
tools to the NSA and other DoD agencies.
\begin{achievements}
\item Holding a principle engineer role on a small team and considerably
  influenced its consistent meeting of deadlines under an Agile methodology.
...
\item Contribution to various open-source projects, most recently starting a
  game server emulator project in Java and MySQL
