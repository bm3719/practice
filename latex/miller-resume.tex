...
{xxx N. Quincy St., Apt xxxx $\bullet$ Arlington, VA 22203}
...
environment where computer science, esoteric programming languages, big data,
and analytics have a considerable influence.  \vspace{7pt}

\header{Skills}
\begin{achievements}
\item Actively proficient in Python, Clojure, Common Lisp, Haskell, Scheme,
...
\item Familiarity with relational and non-relational database design, design
  ...
  (WinForms, WPF, MFC, Swing), data visualization, web development, many JVM
...
\employer{Sotera Defense Solutions (formerly Potomac Fusion,
  Inc.)}{2010-present}{Senior Software Engineer} Currently employed on a DARPA
project called XDATA, performing research towards developing an analytics
framework that operates against extremely large datasets to be used across all
related DARPA projects.
\begin{achievements}
\item Writing composable analytics (potentially part of a cloud analytic
...
\item Researching the state of the art in cloud computing and applicability to
  project goals.
\item Writing large data analytics in Python.
\end{achievements}
