...
"""
    ...
    def do_action(self, sentence):
        ...
        elif (not sentence.object in self.current_room.items) and (not sentence.object in self.inventory):
            print "You do not see %s here." % sentence.object
        # Start handling verbs.
        elif sentence.verb == 'eat':
            if sentence.subject == 'self':
                self.end_game("""
...
""")
                ...
                self.end_game("""
You attempt to take a bite out of Riker, and he overpowers you and instead takes
...
explore human sexuality.  After many days, you eventually die from internal
bleeding.
""")
                else:
                    self.end_game("""
...
brig being sexually violated on a daily basis by your Nausicaan cellmate.
""")
            else:
...
physical agony upon death, your you die with a sick grin on your face.
""")
                else:
                    self.end_game("""
...
sexuality.  After many days, you eventually die from internal bleeding.
""")
            elif sentence.object == 'self':
                print """
You kiss your arms and hands long enough to realize that this activity is
unlikely to improve your self-esteem or sense of self-worth any.
"""
            else:
                print """
You kiss the %s passionately, to no effect.
""" % sentence.object
        elif sentence.verb == 'examine':
            if sentence.object == 'riker':
                print """
Riker is posing here, barrel-chested and confident.  The top of his uniform
is unzipped a few inches past Starfleet standard, and a manly tuft of chest
hair is sprouting forth.  Riker glances over at you and decides you aren't
worthy of his interest.  He is apparently just back from an away mission,
as he is sporting a type 1 phaser on his belt.
"""
            elif sentence.object == 'troi':
                print """
...
Geordi perhaps put him in sleep mode to save power, until Data's head
eventually swivels inhumanly in your direction and says \"Greetings, Crewman.\"
"""
            elif sentence.object == 'spot':
                print """
...
unfamiliar urge that you find it hard to control.
"""
            elif sentence.object == 'phaser':
                print """
The standard issue Federation sidearm, the Type 1 phaser pistol.  This model
contains a 20 round magazine, polished feed-ramp, case-hardened steel frame,
and high visibility tritium sights.
"""
...
"""
                ...
                print """
Troi feels soft, warm, and squishy.
"""
            elif sentence.object == 'data':
                print """
Data feels cold and lifeless.
"""
            elif sentence.object == 'spot':
                print """
Spot feels furry.
